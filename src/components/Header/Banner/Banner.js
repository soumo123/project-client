                            ...
                            <div className="row align-items-center g-4 justify-content-center">
                                <div className="col-xl-4 col-md-6" style={{ cursor: "pointer" }}>
                                    <div className="banner-box rounded-2 overflow-hidden position-relative banner-color-green z-1">
                                        ...
                                        <span className="gshop-subtitle fs-xxs mb-1 text-dark d-inline-block">{settings.headerMiddleCard1}</span>
                                        <h4 className="mb-6 ">{settings.footeMiddleCard1}</h4>
                                ...
                                <div className="col-xl-4 col-md-6" style={{ cursor: "pointer" }}>
                                    <div className="banner-box rounded-2 overflow-hidden position-relative banner-color-green z-1">
                                        ...
                                        <span className="gshop-subtitle fs-xxs mb-1 text-dark d-inline-block">{settings.headerMiddleCard2}</span>
                                        <h4 className="mb-6">{settings.footeMiddleCard2}</h4>
                                        <Link to="/products" className="explore-btn fw-bold text-dark">Shop Now<span className="ms-1"><ArrowForwardIcon /></span></Link>
                                    </div>
                                </div>
                                <div className="col-xl-4 col-md-6" style={{ cursor: "pointer" }}>
                                    <div className="banner-box rounded-2 overflow-hidden position-relative z-1 banner-color-secondary">
                                        ...
                                        <span className="badge bg-danger gshop-subtitle mb-1">{settings.headerMiddleCard3}</span>
                                        <h4 className="mb-6">{settings.footeMiddleCard3}</h4>
                                        <Link to="/products" className="explore-btn fw-bold text-dark">Shop Now<span className="ms-1"><ArrowForwardIcon /></span></Link>
                                    </div>
                                </div>
                            </div>
