                                ...
                                <div className="col-xxl-8 col-xl-9">
                                    <ul className="d-flex align-items-center justify-content-center justify-content-xl-end topbar-info-right">
                                        ...
                                        <li className="nav-item dropdown tt-language-dropdown">
                                            ...
                                            {
                                                showLan ? (
                                                    <ClickAwayListener onClickAway={() => setShowLan(false)}>
                                        ...
                                        <li className="nav-item dropdown tt-curency-dropdown" onClick={() => setShowCurrency(!showCurrency)}>
                                            ...
                                            {
                                                showCurrency ? (
                                                    <ClickAwayListener onClickAway={() => setShowCurrency(false)}>
                                ...
                                <div className="col-xxl-10 col-xl-9 col-md-9 col-7">
                                    <div className="gshop-navbar-right d-flex align-items-center justify-content-end position-relative">
                                        <div className="category-dropdown position-relative d-none d-md-inline-block">
                                            <a href="#" className="category-dropdown-btn fw-bold d-none d-sm-inline-block" onClick={() => setBrowseCat(!browseCategory)}>Browse Category<span
                                                className="ms-1"><KeyboardArrowDownIcon /></span></a>
                                            ...
                                            <div className="gshop-header-user position-relative">
                                                ...
                                                <div className="user-menu-wrapper">
                                                    <ul className="user-menu">
                                                        ...
                                                        <li><a href="cart.html"><span className="me-2"><SellIcon /></span>My Cart</a></li>
                                            ...
                                            <div className="gshop-header-cart position-relative">
                                                ...
                                                <div className="cart-box-wrapper">
                                                    <div className="apt_cart_box theme-scrollbar">
                                                        <ul className="at_scrollbar scrollbar">
                                                            <li className="d-flex align-items-center">
                                                                <div className="thumb-wrapper">
                                                                    <a href="#">
                                                                        {/* <img src="assets/img/products/thumb-sm-1.png" alt="products" className="img-fluid"> */}
                                                                ...
                                                                <div className="items-content ms-3">
                                                                    ...
                                                                    <div className="products_meta d-flex align-items-center">
                                                                        ...
                                                                        <button className="remove_cart_btn"><i
                                                            ...
                                                            <li className="d-flex align-items-center">
                                                                <div className="thumb-wrapper">
                                                                    <a href="#">
                                                                        ...
                                                                        {/* <img src="assets/img/products/thumb-sm-2.png" alt="products" className="img-fluid"> */}
                                                            ...
                                                            <li className="d-flex align-items-center">
                                                                <div className="thumb-wrapper">
                                                                    <a href="#">
                                                                        {/* <img src="assets/img/products/thumb-sm-3.png" alt="products" className="img-fluid"> */}
                                                            ...
                                                            <li className="d-flex align-items-center">
                                                                <div className="thumb-wrapper">
                                                                    <a href="#">
                                                                        {/* <img src="assets/img/products/thumb-sm-4.png" alt="products" className="img-fluid"> */}
                                                        ...
                                                        <a href="checkout.html" className="btn btn-primary btn-md d-block mt-4"><span
                                                            className="me-2"><WalletIcon /></span>Checkout</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
